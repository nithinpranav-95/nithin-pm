...
export function YouTubeLogo({ className, ...props }: ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function N26Logo({ className, ...props }: ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function DuolingoLogo({ className, ...props }: ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export function DoctolibLogo({ className, ...props }: ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 32 36"
      fill="currentColor"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15.128 1.787C30.08 3.375 30.08 12.785 29.215 17.548c-.491 2.8-3.031 16.771-19.976 16.8-6.697 0-7.707-.779-7.361-2.28.167-.685 2.482-9.337 4.152-15.577.934-3.489 1.666-6.224 1.708-6.39.504-2.016 2.471-1.716 2.876-1.654.035.005.059.009.068.009.058.029.087.087.087.144-.151 1.29-1.984 11.202-2.92 16.267-.321 1.733-.536 2.899-.544 2.958-.26 1.703 0 1.876 2.107 1.876 10.421 0 14.202-7.188 15.241-12.961C26.414 6.752 16.658 3.779 3.004 4.991c-.013 0-.037.001-.07.002-.248.008-.987.032-1.344-.146-.52-.231-.953-.866-1.068-1.212a.662.662 0 0 1 .115-.634C4.69 2.222 11.173 1.383 15.128 1.787z"
      />
    </svg>
  );
}

export function SynthflowLogo({ className, ...props }: ComponentProps<"svg">) {
  return (
    <svg
      viewBox="0 0 500 500"
      fill="currentColor"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M493.34 345.258C494.57 430.364 425.703 500 340.861 500L246.812 499.89C216.51 499.868 191.965 475.279 191.965 444.976C191.965 414.652 216.554 390.063 246.878 390.063H339.807C362.858 390.063 382.436 373.363 383.359 349.169C384.282 324.976 364.857 305.001 340.861 305.001H154.982C71.3041 305.001 1.47023 238.551 0.195733 154.874C-1.10074 69.702 67.8102 0 152.675 0H410.98C441.349 0 465.96 24.611 465.96 54.9793C465.96 85.3476 441.349 109.959 410.98 109.959H153.708C130.657 109.959 111.078 126.659 110.155 150.853C109.232 175.046 128.657 195.021 152.653 195.021H338.422C422.166 195.021 492.13 261.514 493.34 345.258ZM137.161 445.196C137.161 475.464 112.625 500 82.3573 500C52.0901 500 27.5538 475.464 27.5538 445.196C27.5538 414.929 52.0901 390.393 82.3573 390.393C112.625 390.393 137.161 414.929 137.161 445.196Z"
      />
    </svg>
  );
}

export function MaritimeLogo({ className, ...props }: ComponentProps<"svg">) {
...
export function CompanyLogo({ slug, className = "h-4 w-4", ...props }: CompanyLogoProps) {
  switch (slug) {
    case "youtube":
      return <YouTubeLogo className={className} {...props} />;
    case "n26":
      return <N26Logo className={className} {...props} />;
    case "duolingo":
      return <DuolingoLogo className={className} {...props} />;
    case "doctolib":
